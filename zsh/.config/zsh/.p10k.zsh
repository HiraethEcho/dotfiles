# Generated by Powerlevel10k configuration wizard on 2025-06-15 at 20:06 CST.
...
() {
  ...
  # P9K_TASKWARRIOR_WEEk_COUNT=$(task +WEEK count)
  #
  ...
  # typeset -g POWERLEVEL9K_TASKWARRIOR_CONTENT_EXPANSION='${P9K_TASKWARRIOR_OVERDUE_COUNT:+"!$P9K_TASKWARRIOR_OVERDUE_COUNT/"}$(task due.by:eow -COMPLETED -PARENT -DELETED count)'
